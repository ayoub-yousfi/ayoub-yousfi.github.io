...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
			...
			<span><font size=+0><font color="#1A4280">> Photoshop</font></font></span>
        </div>
    </div>
	<br><br><br><br><br>
	<!--end section-->
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">	
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							...
							<div class="entry-content">	
                                ...
                                <font size=+3><font color="#D8242F"><B>Photoshop</B></font></font>
									<!--<a href="blog.html">Adipisicing elit, sed do eiusmod tempor</a>-->
								</h2>
                                <font color="#1A4280"><h2><font size="+2">Pourquoi choisir une formation Photoshop ?</font></h2></font>
                                <h2><font size=+1>Cette formation à Photoshop va vous permettre d'apprendre et de maîtriser les meilleures techniques de traitement et de création d'images. Nos experts en formation maîtrisent parfaitement le logiciel Adobe Photoshop et l'infographie, et vous proposent une formation dédiée à cet outil.</font></h2>

...
<head>
    ...
    $query = "select * from formations_encours where titre='$title'";
...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <br><br>
    <h3><B><span>Formations En Cours</span></B></h3>
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
            <a href="index.php" ><span><font size=+0><font color="#1A4280">successway</font></font></span></a> 
			<a href="formations_encours.php" ><span><font size=+0><font color="#1A4280">> Formations en cours</font></font></span></a>
						...
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							<div class="entry-header">	
								<div class="blog-image">
									<?php
									echo "<img src=\"backend/img_formations_encours.php?id=".$row['id']."\"class=\"img-responsive\"align=left height='1100' width='1100' >";
									?>

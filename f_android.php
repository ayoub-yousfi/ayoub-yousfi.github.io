...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
			...
			<span><font size=+0><font color="#1A4280">> Android</font></font></span>        </div>
    </div>
	<br><br><br><br><br>
	<!--end section-->
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">	
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							...
							<div class="entry-content">	
                                ...
                                <font size=+3><font color="#D8242F"><B>Android</B></font></font>
                                ...
                                <br>•	concevoir l’architecture technique de l’application.                              
                                <br>•	créer son interface et ses éventuelles animations.
                                <br>•	gérer l’interaction avec l’utilisateur.
                                <br>Il doit également être en veille active sur ces technologies, et plus particulièrement de l’écosystème Google. Par ailleurs, un développeur Android peut facilement décliner ses applications sur d’autres plateformes comme les montres connectées Android ou l'Android TV.
                                <br>En tant que spécialiste de l’univers Google, le développeur Android doit être force de proposition auprès de ses clients ou de son équipe pour tirer le meilleur des nouveautés matérielles et logicielles.
                                </font></h2>

	...
	<section id="fencours">
		<div class="row">
				...
				<div class="divider-des">
					...
					<h4 style="color:#D8242F">Assurer la réussite de votre future vie professionnelle</h4>
					<div id="team">
	...
	<section id="portfolio" >
		<div class="container" id="actualite">
			<div class="row">
				<div class="col-md-12">
					<div class="wow bounceIn">
						<h2 class="wow bounceIn">Actualités</h2>
					</div>
			...
			<div class="col-md-12 text-center wow bounceIn">
                <div class="col" >
                    <a href="modif_actualites.php" style="color:#D8242F ; font-size: 23px;">Modifier les actualités</a>        
                </div>
                    <br>
            </div>
		</div>

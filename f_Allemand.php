...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <br><br>
    <h3><B><span>Formations</span></B></h3>
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
            <a href="index.php" ><span><font size=+0><font color="#1A4280">successway</font></font></span></a> 
			<a href="presentation.php#formation" ><span><font size=+0><font color="#1A4280">> Formations </font></font></span></a>
			<span><font size=+0><font color="#1A4280">> Allemand</font></font></span>
		</div>
    </div>
	<br><br><br><br><br>
	<!--end section-->
						...
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							<div class="entry-header">	
								<div class="blog-image">
                                    <img alt="" src="images/formations/image.jpg" class="img-responsive" style="margin-left:20px">
							...
							<div class="entry-content">	
                                ...
                                <font size=+3><font color="#D8242F"><B>Allemand</B></font></font>
									<!--<a href="blog.html">Adipisicing elit, sed do eiusmod tempor</a>-->
								</h2>
                                			
                                <h2><font size=+1>Apprenez l’allemand efficacement, pour la vie quotidienne, les loisirs, le travail ou les études ; le Centre de Formation Successway est votre partenaire pleinement qualifié pour les cours d’allemand. Notre offre large vous permet de choisir la formule qui correspond le mieux à vos objectifs. La plupart de nos cours d’allemand sont conçus pour les personnes de niveau débutant ou avancé.
                                <br>1) COURS INTENSIFS
                                <br>Apprendre l’allemand de manière intensive et méthodique. Des cours d’allemand toute l’année pour les personnes de niveau débutant ou avancé.
                                <br>2) COURS DU SOIR
                                <br>COURS DU WEEK-END
                                <br>Un entraînement linguistique efficace et varié ayant lieu le soir.
                                <br>3) COURS DE PRÉPARATION À UN EXAMEN
                                <br>Préparation ciblée et intensive à un examen.
                                <br>4) COURS SPÉCIALISÉS À USAGE PROFESSIONNEL
                                <br>Cours d’allemand pour le quotidien en entreprise dans un contexte interculturel.
                                </font></h2>

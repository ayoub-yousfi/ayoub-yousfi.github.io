...
<head>
	...
	$query = "select * from formations_realisees ORDER BY date_debut DESC";
...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
            ...
            <span><font size=+0><font color="#1A4280">> Formations réalisées</font></font></span>
        </div>
    </div>
	<br><br><br><br><br>
	<!--end section-->
						...
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
                            ...
                            <div class="entry-header" >	
								...
								<a href="description_formation_realisee.php?title=<?php echo $row['titre']; ?>"  >
									<?php 
									echo "<img src=\"backend/img_formations_realisees.php?id=".$row['id']."\"class=\"img-responsive\" height='600' width='600'>";
									?>
								</a>

...
if(isset($_POST['upload']))
{
	...
	$query = "insert into formations_realisees (image,titre,description,date_debut,date_fin,duree) VALUES (0x".bin2hex($dataf).",'$title','$description','$date_debut','$date_fin','$duree')";

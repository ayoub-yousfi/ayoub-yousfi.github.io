...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
			...
			<span><font size=+0><font color="#1A4280">> Anglais</font></font></span>        </div>
    </div>
	<br><br><br><br><br>
	<!--end section-->
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">	
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							...
							<div class="entry-content">	
                                ...
                                <font size=+3><font color="#D8242F"><B>Anglais</B></font></font>
									<!--<a href="blog.html">Adipisicing elit, sed do eiusmod tempor</a>-->
								</h2>
                                <font color="#1A4280"><h2><font size="+2">Voulez vous améliorer votre accent en Anglais ainsi qu'enrichir votre vocabulaire ???</font></h2></font>

                                <h2><font size=+1>
                                Successway Training Center a le plaisir d'organiser une Session de Formation en Anglais de communication.
                                <br>Nous vous offrons un programme de formation qui vous permettra d’atteindre vos objectifs (Anglais Scientifique, Anglais Médical, Anglais pétrolier, Anglais de Business, Anglais de communication, Anglais d’Affaires….).

...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
			...
			<span><font size=+0><font color="#1A4280">> C++</font></font></span>        </div>
    </div>
	<br><br><br><br><br>
	<!--end section-->
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">	
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							...
							<div class="entry-content">	
                                ...
                                <font size=+3><font color="#D8242F"><B>C++</B></font></font>
									<!--<a href="blog.html">Adipisicing elit, sed do eiusmod tempor</a>-->
								</h2>

                                <h2><font size=+1>
                                Le C est un langage incontournable qui en a inspiré beaucoup d'autres. Inventé dans les années 70, il continue pourtant à être utilisé bien qu'il ne soit pas orienté objet à l'instar du C++ ou du C#. Il est toujours d'actualité dans la programmation système et la robotique.
                                <br>Cette formation langage C détaille les concepts de base et présente les fondamentaux du langage C à savoir les types scalaires, les structures de contrôle et les types structurés, les fonctions, les pointeurs et les tableaux.
                                <br>Par ailleurs, cette formation langage C insiste sur certains concepts avancés comme la compilation et ses différentes étapes, les pointeurs sur fonctions ou bien les ajouts des normes C99 et C11 tout en apportant un complément théorique riche comme la mémoire centrale, les liens entre pointeurs et tableaux, les fonctions utiles de la bibliothèque standard.

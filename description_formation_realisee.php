...
<head>
    ...
    $query = "select * from formations_realisees where titre='$title'";
...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <br><br>
    <h3><B><span>Formations Réalisées</span></B></h3>
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
            <a href="index.php" ><span><font size=+0><font color="#1A4280">successway</font></font></span></a> 
			<a href="formations_realisees.php" ><span><font size=+0><font color="#1A4280">> Formations réalisées</font></font></span></a>
						...
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							<div class="entry-header">	
								<div class="blog-image">
									<?php
									echo "<img src=\"backend/img_formations_realisees.php?id=".$row['id']."\"class=\"img-responsive\"align=left height='2000' width='2000' >";
									?>
							...
							<div class="entry-content">	
                                ...
                                <h2 class="entry-title">
                                <?php 
                                    if ( ($row['date_debut'])!=(0000-00-00)  )
                                    {
                                        echo "<i class='font-icon-post fa fa-clock-o blue-color'></i>"," ";
                                        echo "<B><font size=+1><font color=#1A4280>Date début:</font></font></B>"," ", "<font size=+1><font color=#D8242F>$row[date_debut]</h2></font></font>" ;
                                    }  
                                    ?>
								</h2>	
                                <h2 class="entry-title">
                                <?php 
                                    ...
                                    {
                                        echo "<i class='font-icon-post fa fa-clock-o blue-color'></i>"," ";
                                        echo "<B><font size=+1><font color=#1A4280>Date fin:</font></font></B>"," ", "<font size=+1><font color=#D8242F>$row[date_fin]</h2></font></font>" ;
                                    }  
                                    ?>
								</h2>
                                ...
                                <?php
                                    if( ($row['duree'])!=null  )
                                    {
                                        echo " ","<i class='fa fa-hourglass blue-color'  ></i>","&nbsp ";
									    echo "<B><font size=+1><font color=#1A4280> Durée de la formation:</font></font></B>"," ","<font size=+1><font color=#D8242F>$row[duree]</h2></font></font>";
                                    }
								?>

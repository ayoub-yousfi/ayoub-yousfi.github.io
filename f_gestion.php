...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
			...
			<span><font size=+0><font color="#1A4280">> Gestion</font></font></span>        </div>
    </div>
	<br><br><br><br><br>
	<!--end section-->
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">	
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							...
							<div class="entry-content">	
                                ...
                                <font size=+3><font color="#D8242F"><B>Gestion</B></font></font>
									<!--<a href="blog.html">Adipisicing elit, sed do eiusmod tempor</a>-->
								</h2>
                                			
                                <h2><font size=+1>
                                  •	Finances, comptabilité et fiscalité.
                                <br>•	Gestion et droit des entreprises. 
                                <br>•	Qualité, environnement, sécurité et santé au travail.
                                <br>•	Et toutes autres disciplines touchant les sciences des entreprises et les pratiques professionnelles.
                                </font></h2>

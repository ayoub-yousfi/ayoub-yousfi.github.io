...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <div class="row">
        <div class="col-md-12 text-center wow bounceIn">
			...
			<span><font size=+0><font color="#1A4280">> Bureautique</font></font></span>        </div>
    </div>
	<br><br><br><br><br>
	<!--end section-->
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">	
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							...
							<div class="entry-content">	
                                ...
                                <font size=+3><font color="#D8242F"><B>Bureautique</B></font></font>
									<!--<a href="blog.html">Adipisicing elit, sed do eiusmod tempor</a>-->
								</h2>
                                <font color="#1A4280"><h2><font size="+2">formation Informatique Bureautique (100% pratique)</font></h2></font>
                                <h2><font size=+1>
                                PROGRAMME DE LA FORMATION :                              
                                <br>1) WORD: Initiation/Intermédiaire/Perfectionnement.
                                <br>- Gestion courant (Création d’un nouveau document, Ouvrir, Fermer).
                                <br>- Traitement de texte en Arabe et Français (Caractères, Paragraphes, Bordures et Trames, …).
                                <br>- Mise en page & Impression.
                                <br>- Conception de tableaux.
                                <br>- Utilisation des Outils de dessin des matières, Index, …).
                                <br>2) EXCEL: Initiation/Intermédiaire/Perfectionnement.
                                <br>- Conception de tableaux.
                                <br>- Saisie et Présentation de données.
                                <br>- Gestion des feuilles de calculs…
                                <br>3) POWERPOINT: Initiation/Intermédiaire/Perfectionnement.
                                <br>- Gestion des présentations.
                                <br>- Création de diapositives (Gestion de texte, Création de tableau, Graphique, Outils de dessin, Insertion d’images, Photos, …).
                                </font></h2>
                                <font color="#D8242F"><h2><font size="+2">**La formation est certifiée** </font></h2></font>

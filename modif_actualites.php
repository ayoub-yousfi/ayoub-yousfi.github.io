...
if (($login=="admin") && ($pass=="successway") && !(isset($_POST['add_actualite'] )) && !(isset($_POST['delete_actualite']) ))
{
	?>
	<div class="container" style="padding-top: 50px;">
		<div class="row">
			<div class="col-md-12 text-center wow bounceIn">        
				<form action="" method="post">
					...
					<div><input type="submit" name="add_actualite" value="Ajouter une actualité" style="text-align:center; font-size: 20px; background-color: #1A4280; color: #FFFFFF; border: none;margin-left:0px; margin-top:30px; height:50px;width:550px;border-radius:10px; "></div>
					<div><input type="submit" name="delete_actualite" value="Retirer une actualité" style="text-align:center; font-size: 20px; background-color: #1A4280; color: #FFFFFF; border: none;margin-left:0px; margin-top:30px; height:50px;width:550px;border-radius:10px; "></div>
					<div><a href="backend/logout_actualites.php" style=" text-decoration:none;text-align:center; font-size: 20px; background-color: #1A4280; color: #FFFFFF; border: none;margin-left:0px; margin-top:30px; height:50px;width:850px;border-radius:10px;width:550px;display:inline-block;line-height:50px;">Déconnecter</a><br><br><br><br><br><br><br></div>
...
if (($login=="admin") && ($pass=="successway") && isset($_POST['add_actualite'] ))
{
	...
	<div class="container" style="padding-top: 50px;">
			<div class="row">
				<div class="col-md-12 text-center wow bounceIn">  
					...
					<form action="backend/upload_actualites.php" method="post" enctype="multipart/form-data">
					<br><br><br><br>
					<div>
							<div style="color:#1A4280";>
								<h3><B><font size=+3>Ajouter une actualité</font></B></h3>
							</div>
						<br><br><br>
						<div style="display:flex;">
						<div style="color:#1A4280";><strong><font size=+1>Nom de l'actualité:</font></strong></div>
						<div> <input class="form-control input-lg" type="text" name="titre" placeholder="Entrer le nom de l'actualité" required style="border-width:2px; font-size: 20px; color: black;border-color:#D8242F ;margin-left:95px;border-radius:10px;"></div>
						...
						<div style="display:flex;">
						<strong><font color="#1A4280"><font size=+1>Description de l'actualité:</font></font></strong>
						<div style="color:#1A4280";>
							<textarea class="form-control input-lg" rows="5" cols="80" name="description" placeholder="Entrer la description de l'actualité  "style="font-size: 20px;border-width:2px;border-radius:10px; margin-left:35px; color: black;border-color:#D8242F ;"></textarea>
						</div></div>
						<br><br>
						...
						<div><a href="backend/logout_actualites.php" style="text-decoration:none;text-align:center; font-size: 23px; background-color: #1A4280; color: #FFFFFF; border: none;margin-left:0px; margin-top:30px; height:50px;width:550px;border-radius:10px;display:inline-block;line-height:50px;">Déconnecter</a><br><br><br><br><br><br><br></div>
					</form>
				</div>
			</div>
...
if (($login=="admin") && ($pass=="successway") && isset($_POST['delete_actualite'] ))
{
	...
	<div class="container" style="padding-top: 50px;">
		<div class="row">
				<div class="col-md-12 text-center wow bounceIn">  
					<form action="backend/delete_actualites.php" method="post" enctype="multipart/form-data">
					<br><br><br><br><br><br><br><br>
					<div>
							<div style="color:#1A4280";>
								<h3><B><font size=+3>Retirer une actualité</font></B></h3>
							</div>
						<br><br><br>
							...
							<div class="row">
								...
								<div class="col-sm">
									<div style="color:#1A4280";>
										<label for="username"><font size=+1>Nom de l'actualité: </font></label>
										<input class="form-control input-lg" type="text" name="titre" placeholder="Entrer le nom de l'actualité" required style="display: inline-block;border-width:2px; font-size: 20px; color: black;border-color:#D8242F ;margin-left:50px;border-radius:10px;width: 500px;">
									</div>
								</div>
						...
						<div><a href="backend/logout_actualites.php" style="text-decoration:none;text-align:center; font-size: 20px; background-color: #1A4280; color: #FFFFFF; border: none;margin-left:0px; margin-top:30px; height:50px;width:550px;border-radius:10px;width:550px;display:inline-block;line-height:50px;">Déconnecter</a><br><br><br><br><br><br><br></div>
					</form>
				</div>
		</div>
